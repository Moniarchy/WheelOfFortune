...
namespace WheelOfFortune
{
    ...
    /// RoundTotal is the amount of money earned by the player, during the current round of the game
    /// </summary>
    public class Player
    {
        /// <summary>
        ...
        /// <summary>
        /// GameTotal: An int representing the sum of money the player has earned across all rounds. It always starts at 0, but increases and decreases across the rounds of the game. It can be negative.
        /// </summary>
